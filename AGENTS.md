...
- Owner: Jixian Liu (`JeanLew01`). Repository: `JeanLew01/JeanLew01.github.io`.
- Production URL: `https://jeanlew01.github.io`; keep `baseurl: ""`.
- Build with `bundle exec jekyll build`, and preview at `http://localhost:4000/`.
...
3. **This personal site uses an empty baseurl.** Use `bundle exec jekyll build` and preview at `http://localhost:4000/`.
