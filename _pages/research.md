...
### Non-parametric methods for safety-critical control

My work explores safety-critical control and nonparametric safety verification.
...
My earlier research includes smart predict-then-optimize methods with dependent data and shared storage for net zero energy buildings.
